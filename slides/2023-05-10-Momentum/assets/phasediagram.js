function phaseDiagram(divin) {
  ...
  var textCaptions = ["<small><center><b style=\"color:black\">Overdamping</b></center><div style=\"margin:5px\"></div> When " + MathCache("beta") + " is too small (e.g. in Gradient Descent, " + MathCache("beta-equals-zero") + "), we're over-damping. The particle is immersed in a viscous fluid which saps it of its kinetic energy at every timestep.</small>",
                      "<small><b style=\"color:black\"><center>Critical Damping</center></b> <div style=\"margin:5px\"></div>The best value of " + MathCache("beta") + " lies in the middle of the two extremes. This sweet spot happens when the eigenvalues of " + MathCache("r") + " are repeated, when " + MathCache("beta-equals-one-minus") + ".</small>",
                      "<small><b style=\"color:black\"><center>Underdamping</center></b><div style=\"margin:5px\"></div> When " + MathCache("beta") + " is too large we're under-damping. Here the resistance is too small, and spring oscillates up and down forever, missing the optimal value over and over.</small>"]
